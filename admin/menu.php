          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Input Menu dan makanan</h6>
              </div>
            </div>
            <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  id="menu" name="menu" placeholder="Nama Makanan">
                  </div>
                  <div class="form-group">
                    <label> Harga </label>
                  ...
                  <?php
                            ...
                            echo '
                                  <tr>
                                    ...
                                    <td> Rp.'.$row['harga'].'</td>
                                    <td>
                                          <img src="menu/'.$row['gambar'].'" width="70" height="90">
                                    </td>
                                    <td class="align-middle">
                                    <a href ="editmenu.php?id_menu='.$row['id_menu'].'"><i class="btn  btn-primary">edit</i></a>
                                    <a href ="hapusmenu.php?id_menu='.$row['id_menu'].'"><i class="btn  btn-danger">hapus</i></a>
                                    </td>
                                  </tr>
                                ';
                                $no++;
